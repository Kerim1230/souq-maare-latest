          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                <p className="text-teal-300/60 text-[11px]">اسأل أي سؤال عن سوق مارع</p>
                {providerName && (
                  <>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
            ...
            {messages.length === 0 && aiEnabled === true && (
              <div className="flex flex-col items-center justify-center py-12 gap-3">
                ...
                <p className="text-[12px] text-[var(--color-text-tertiary)] text-center max-w-[280px]">اسألني أي سؤال عن سوق مارع وكيفية استخدام التطبيق</p>
                {connectionConfirmed && (
