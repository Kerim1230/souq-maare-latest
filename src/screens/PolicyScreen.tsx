...
const sections = [
  {
    ...
    content: 'يُشترط استخدام تطبيق "سوق الحرية" الإلكتروني الالتزام بالشروط والأحكام التالية. باستخدامك للتطبيق، فإنك توافق على هذه الشروط. يُمنع استخدام المنصة لأي أغراض غير مشروعة أو مخالفة للقوانين السورية المعمول بها.',
  },
  {
