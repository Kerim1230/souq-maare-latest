/**
 * 🔍 Full Application Audit Script — سوق مارع الإلكتروني
 *
 ...
 *   AUDIT_BASE_URL=https://souq-maare-latest.vercel.app npx tsx scripts/full-audit.ts
...
function extractSessionCookie(cookieHeader?: string): string {
  ...
  // The app uses 'suq_maraa_sid' as the session cookie name
  const match = cookieHeader.match(/suq_maraa_sid=[^;]+/);
...
async function main() {
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('🔍 سوق مارع — Full Application Audit');
  console.log('═══════════════════════════════════════════════════════════');
